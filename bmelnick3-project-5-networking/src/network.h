...
enum {
    DATA = 0,   // data packet that contains part of a message in its payload
    LAST_DATA,  // like a data packet, signifies last packet in a message
    ACK,        // acknowledges the receipt of the last packet
    NACK,       // negative acknowledgement stating that the last packet was corrupted
    TERM
};
