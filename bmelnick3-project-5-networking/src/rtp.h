...
typedef struct rtp_connection {
    ...
    // data structures for ack_mutex when a feedback packet has been received
    int ack;   // 1 for ack, 0 for nack     
    int ack_received; // 1 if ack/nack feedback packet was sent 
